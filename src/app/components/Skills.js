      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-4">
          {skills.map((skill, index) => (
            <div
              key={skill}
              className="bg-primary-dark rounded-lg shadow-md relative overflow-hidden group transition-all duration-300 ease-in-out transform hover:scale-110 hover:bg-white"
